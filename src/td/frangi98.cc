...
//void Frangi98::Detect(const cv::Mat& img, std::list<TextLine*>* tllist) {
...
//    // have not released cclist, for some ccs are referenced by tllist. It's a
//    // tough task to fix without bring any significant changes
...
//}
//
//void Frangi98::Handle(const Mat& gray, std::list<TextLine*>* tllist) {
////  TestUtils::ShowImage(gray);
//  Mat fgray;
